                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Secciones <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo base_url();?>secciones/index">Registrar Nombre de Secci&oacute;n</a></li>
                        <?php endif; ?>
                      <li><a href="<?php echo base_url();?>secciones/list">Verificar Secciones</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-edit"></i> Usuarios <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>usuarios/add">Registrar Usuarios</a></li>
                      <li><a href="<?php echo base_url();?>usuarios/list">Control de Usuario</a></li>                      
                    </ul>
                  </li>
                    <?php endif; ?>


                  <li><a><i class="fa fa-desktop"></i>Materias <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                    <?php if($this->session->userdata("rol")==1 || $this->session->userdata("rol")==2):?>    
                      <li><a href="<?php echo base_url();?>materias/add">Registrar Materias</a></li>
                    <?php endif; ?> 
                      <li><a href="<?php echo base_url();?>materias/list">Verificar Materias</a></li>                     
                    </ul>
                  </li>

                  <li><a><i class="fa fa-table"></i>Administraci&oacute;n<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>notas/add">Registro de Alumnado</a></li>
                      <li><a href="<?php echo base_url();?>notas/list">Verificar Notas</a></li>
                    </ul>
                  </li>                
